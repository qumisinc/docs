...
<Info>
**Model Context Protocol (MCP)** integration enables AI assistants like Claude to directly access and reference Qumis documentation during conversations.
</Info>

## Features

<CardGroup cols={2}>
  <Card title="MCP-Enabled" icon="robot">
...
Access documentation for core Qumis platform capabilities:

- **Chat Features** - `/features/chats`
- **Document Vault** - `/features/document-vault`
- **Legal Search** - `/features/legal-search`
- **Prompt Library** - `/features/prompt-library`
- **Reports** - `/features/reports`

### Reports

Detailed guides for AI-powered reporting tools:

- **Claims Reports** - `/reports/claims`
- **Policy Analysis** - `/reports/policy-analysis`
- **Coverage Tables** - `/reports/coverage-table`
- **Contract Review** - `/reports/contract-review`
...
- **Brokers** - `/playbooks/for-brokers`
- **Claims Professionals** - `/playbooks/for-claims-professionals`
- **Account Managers** - `/playbooks/for-account-managers`
- **Producers** - `/playbooks/for-producers`
- **Service Teams** - `/playbooks/for-service-teams`

### Getting Started

Onboarding and implementation guides:

- **Implementing AI** - `/get-started/foundations-for-success/implementing-ai`
- **Single Sign-On** - `/get-started/setup-and-access/single-sign-on`
- **Navigating Dashboard** - `/get-started/setup-and-access/navigating-the-dashboard`
- **Change Management** - `/get-started/foundations-for-success/change-management`

### Internal Documentation

Engineering and infrastructure resources:
...
- **Troubleshooting** - `/internal/engineering/troubleshooting/common-issues`
...
<CardGroup cols={2}>
  <Card title="Contact Support" icon="headset" href="mailto:support@qumis.ai">
    Email our support team for assistance
  </Card>
  <Card title="View Full Spec" icon="file-code" href="/openapi.json">
