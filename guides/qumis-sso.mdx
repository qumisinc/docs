...
<Step title="Verify User Details">
...
<Steps>
<Step title="Enable SSO for Additional User Groups">
Enable SSO for additional user groups as planned.
</Step>

<Step title="Communicate the New Login Process">
Communicate the new login process to your users.
</Step>

<Step title="Update Internal Documentation">
...
<Step title="Redirect to Identity Provider">
Users are redirected to your organization's identity provider.
</Step>

<Step title="Authenticate and Access Qumis">
...
<Info>
For assistance with SSO configuration or troubleshooting, email [support@qumis.ai](mailto:support@qumis.ai).
