...
<AccordionGroup>
  ...
  <Accordion title="License Limitations">
...
<CardGroup cols={2}>
  <Card title="Search Knowledge Base" icon="book">
  ...
  <Card title="Status Page" icon="signal-stream">
