...
<CardGroup cols={2}>
  <Card title="View History" icon="history">
  ...
  <Card title="Restore Versions" icon="rotate-ccw">
    Restore earlier versions if needed
  </Card>

  <Card title="Track Changes" icon="user-clock">
