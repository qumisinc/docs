...
<Accordion title="Customer Email Response Generator" icon="mail">
...
<Accordion title="Support Ticket Triage" icon="clipboard-list">
...
<Accordion title="Bug Report Formatter" icon="bug">
