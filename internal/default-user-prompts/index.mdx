...
<Info>
This page contains pre-configured policy checklists that are automatically loaded for specific clients. These templates ensure consistent data extraction across different insurance policy types.
</Info>

<Tip>
**Quick Navigation:** Use the tabs below to switch between client-specific checklists.
</Tip>

<Tabs>
  <Tab title="Hummel Group">
