...
<CardGroup cols={3}>
  <Card title="Positioning & Value Props" icon="crosshairs" href="/internal/messaging/positioning" />
  <Card title="Audience Messaging" icon="users" href="/internal/messaging/audience-messaging" />
  <Card title="Persona Messaging" icon="user-tag" href="/internal/messaging/persona-messaging" />
