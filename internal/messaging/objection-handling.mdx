...
description: "10 common objections with initial responses, follow-ups, and proof point pairings"
icon: "shield"
noindex: true
---
...
<Info>
**Principles for all objection handling:**
...
<AccordionGroup>
  <Accordion title='Objection 1: "How is this different from ChatGPT?"'>
  ...
  <Accordion title='Objection 2: "We already have [workflow automation tool]"'>
  ...
  <Accordion title='Objection 3: "How do I know I can trust the AI output?"'>
  ...
  <Accordion title='Objection 4: "Is this going to replace my team?"'>
  ...
  <Accordion title='Objection 5: "What about security and compliance?"'>
  ...
  <Accordion title='Objection 6: "How long does implementation take?"'>
  ...
  <Accordion title='Objection 7: "We tried [other AI tool] and it didn&#39;t work"'>
  ...
  <Accordion title='Objection 8: "This is too expensive" / "We don&#39;t have the budget"'>
  ...
  <Accordion title='Objection 9: "Our IT team can build this internally"'>
  ...
  <Accordion title='Objection 10: "We need to see it work on our policies first"'>
