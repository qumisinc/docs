...
<CardGroup cols={2}>
  <Card title="Qumis Overview" icon="building" href="/internal/assets/llms/qumis-overview.llms.txt">
    **Contents:**
  ...
  <Card title="Qumis Design System" icon="palette" href="/internal/assets/llms/qumis-design.llms.txt">
    **Contents:**
