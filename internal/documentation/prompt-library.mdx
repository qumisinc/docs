...
A curated collection of battle-tested prompts for AI assistants (ChatGPT, Claude, Cursor). Includes 15+ prompts across 5 categories, plus 2 LLM context files to enhance AI understanding of Qumis systems. Designed for engineers, technical writers, product managers, and anyone working with AI tools at Qumis.

## Most Used Prompts

<CardGroup cols={3}>
  <Card title="Self-Review Process" icon="search" href="#self-review">
...
<Steps>
  ...
  <Step title="Download LLM context files (recommended)">
    For better results, download the [Qumis Overview](/internal/assets/llms/qumis-overview.llms.txt) and [Qumis Design System](/internal/assets/llms/qumis-design.llms.txt) context files and add them to your AI tool. This helps the AI understand Qumis-specific terminology and patterns. See the [LLM Context Files](#llm-context-files) section above for more details.
  </Step>
