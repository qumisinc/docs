...
<CardGroup cols={3}>
  ...
  <Card title="Full Docs Bundle" icon="book-open" href="/assets/internal/llms/llms-full.txt">
    **Contents:**
  ...
  <Card title="External Docs Bundle" icon="globe" href="/assets/internal/llms/llms-external.txt">
    **Contents:**
  ...
  <Card title="Internal Docs Bundle" icon="lock" href="/assets/internal/llms/llms-internal.txt">
    **Contents:**
