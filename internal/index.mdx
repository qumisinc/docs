...
<CardGroup cols={3}>
  <Card
    ...
    icon="building"
    href="/internal/company-overview"
  >
    About Qumis, team directory, values, policies, and tools
  </Card>
  <Card
    title="Engineering"
    icon="code"
...
<CardGroup cols={2}>
  ...
  <Card
    title="Full Docs Bundle"
    icon="book-open"
    href="/assets/internal/llms/qumis-full.llms.txt"
  >
  ...
  <Card
    title="External Docs Bundle"
    icon="globe"
    href="/assets/internal/llms/qumis-external.llms.txt"
  >
  ...
  <Card
    ...
    icon="lock"
    href="/assets/internal/llms/qumis-internal.llms.txt"
  >
  ...
  <Card
    ...
    icon="wrench"
    href="/assets/internal/llms/qumis-engineering.llms.txt"
  >
  ...
  <Card
    ...
    icon="megaphone"
    href="/assets/internal/llms/qumis-messaging.llms.txt"
  >
