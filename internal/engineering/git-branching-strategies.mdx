...
<Accordion title="🚨 EMERGENCY: Need to fix your branch RIGHT NOW?">
...
```
Before (Out of Sync):
release:        A---B---C---D (other engineer's commits)
                 \
your-feature:     \---X---Y---Z (your commits)

After Updating (Clean):
release:        A---B---C---D
                           \
your-feature:               X'---Y'---Z' (your commits, rebased)
```
