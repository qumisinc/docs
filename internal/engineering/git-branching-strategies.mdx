...
## FRAP Method - The Simplified Approach

For a streamlined way to sync your feature branch with `release`, use the **FRAP** method:

- **F**etch
- **R**ebase
- **A**I Resolve Conflicts
- **P**ush

<Info>
**This should be done before submitting a PR for review.** It's also good practice for any feature branches that are behind `release`.
</Info>

### FRAP Workflow

```bash
# Checkout your feature branch if you aren't on it already
git checkout erik/eng-123-my-feature

# FRAP
# ----

# FETCH - Get latest release without changing branches
git fetch origin release:release

# REBASE - Rebase onto release from your branch
git rebase release

# AI RESOLVE - If you encounter merge conflicts
...
# PUSH - After successful rebase, push your branch
git push origin --force-with-lease

# Done! Your feature branch is now 0 commits behind release.
```
...
# Automatically move fixup commits to the right place
