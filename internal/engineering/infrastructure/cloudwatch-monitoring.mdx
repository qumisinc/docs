...
|------------|---------|-----------|-------------|
| Dev | API | `/ecs/qumis-dev/api` | `qumis_dev` |
| Dev | Web | `/ecs/qumis-dev/web` | `qumis_dev` |
| Dev | Sidekiq | `/ecs/qumis-dev/sidekiq` | `qumis_dev` |
| Production | API | `/ecs/qumis-prod/api` | `qumis_prod` |
| Production | Web | `/ecs/qumis-prod/web` | `qumis_prod` |
| Production | Sidekiq | `/ecs/qumis-prod/sidekiq` | `qumis_prod` |
...
```bash
# Tail ECS service logs in real-time
aws logs tail /ecs/qumis-prod/api --profile qumis_prod --follow
aws logs tail /ecs/qumis-prod/web --profile qumis_prod --follow
aws logs tail /ecs/qumis-prod/sidekiq --profile qumis_prod --follow
...
<Tabs>
  ...
  <Tab title="Web Service">
    ...
    aws logs filter-log-events \
      --log-group-name /ecs/qumis-prod/web \
      --filter-pattern "Error" \
      --profile qumis_prod
  ...
  <Tab title="Sidekiq Service">
    ...
    aws logs filter-log-events \
      --log-group-name /ecs/qumis-prod/sidekiq \
