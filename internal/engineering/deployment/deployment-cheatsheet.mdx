...
<Tip>
  **Visual Guide**: See [AWS Environments → AWS Console Access](/internal/engineering/infrastructure/aws-environments#aws-console-access) for a screenshot showing how to select the production environment from the SSO portal.
</Tip>
