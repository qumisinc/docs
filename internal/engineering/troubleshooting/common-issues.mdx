...
<AccordionGroup>
  <Accordion title="Rails server won't start">
  ...
  <Accordion title="Node/npm issues">
...
<AccordionGroup>
  ...
  <Accordion title="AWS authentication failures">
  ...
  <Accordion title="GitHub token expired">
...
<AccordionGroup>
  <Accordion title="ECS service not starting">
    ...
    **Solutions**:
    ...
    TASK_ARN=$(aws ecs list-tasks --cluster qumis-prod --service-name api --desired-status STOPPED --profile qumis_prod --query 'taskArns[0]' --output text)
  ...
  <Accordion title="Container keeps restarting">
    ...
    **Solutions**:
    ...
    aws logs tail /ecs/qumis-prod/api --profile qumis_prod --follow

    # Check health check configuration
    aws ecs describe-task-definition \
      --task-definition qumis-api-prod \
      --profile qumis_prod \
    ...
    aws cloudwatch get-metric-statistics \
      ...
      --dimensions Name=ServiceName,Value=api Name=ClusterName,Value=qumis-prod \
  ...
  <Accordion title="Sidekiq jobs not processing">
    ...
    **Solutions**:
    ...
    # Check Sidekiq logs
    aws logs tail /ecs/qumis-prod/sidekiq \
      --profile qumis_prod \
      --follow
    ...
    # Restart Sidekiq service if needed
...
<AccordionGroup>
  <Accordion title="Missing CloudWatch logs">
