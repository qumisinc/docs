...
<Note>
**Full Install** includes shell integration with helpful aliases and completions. **Binary Only** is faster but lacks these conveniences.
</Note>
...
<Tip>
Use **nvm** if you need to manage multiple Node.js versions across different projects. Use **Homebrew** for a simpler single-version setup.
</Tip>
...
<Steps>
  ...
  <Step title="Test Access">
    ...
    <Tip>
    Use `qumis aws login` for a streamlined experience. It handles profile selection and SSO automatically.
    </Tip>
  </Step>
</Steps>
