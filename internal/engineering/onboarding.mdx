...
<Steps>
  ...
  <Step title="Configure AWS Access">
    ...
    **AWS SSO Portal Access**: [https://qumis.awsapps.com/start/#/?tab=accounts](https://qumis.awsapps.com/start/#/?tab=accounts)
    ...
    Create your `~/.aws/config` file with this template for CLI access:
    ```ini
    ...
    See [Tools Setup](/internal/engineering/tools-setup) for the complete configuration including Shared Services.
  </Step>
