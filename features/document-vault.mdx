...
2. Send the email to [**clerk@qumis.ai**](mailto:clerk@qumis.ai).
...
![Vault showing successfully uploaded file with green highlight and checkmark](/images/screenshots/06.png)
...
![Vault view showing multiple documents with search, filters, and pagination controls]
