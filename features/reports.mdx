...
<CardGroup cols={2}>
  <Card title="Comparison Report" icon="code-compare" href="/reports/comparisons">
  ...
  <Card title="Single Policy Analysis" icon="file-contract" href="/reports/policy-analysis">
  ...
  <Card title="Claim Analysis" icon="gavel" href="/reports/claims">
  ...
  <Card title="Custom Reports" icon="wand-magic-sparkles" href="/reports/custom-reports">
...
<AccordionGroup>
  <Accordion title="Attorney-Trained AI Analysis">
  ...
  <Accordion title="Multi-Agent Validation">
  ...
  <Accordion title="Interactive Chat with Qumis Clerk">
  ...
  <Accordion title="Document Vault Integration">
  ...
  <Accordion title="Citations and Transparency">
...
<CardGroup cols={2}>
  <Card title="Start with Comparisons" icon="rocket" href="/reports/comparisons">
    See Qumis's analytical power in action by comparing quotes or policies side-by-side
  </Card>
  <Card title="Analyze a Single Policy" icon="magnifying-glass" href="/reports/policy-analysis">
    Evaluate a prospect's existing coverage to identify opportunities and gaps
  </Card>
  <Card title="Review Contract Compliance" icon="clipboard-check" href="/reports/contract-review">
    Verify whether policies meet contract requirements automatically
  </Card>
  <Card title="Create Custom Analysis" icon="wand-magic-sparkles" href="/reports/custom-reports">
...
<CardGroup cols={2}>
  ...
  <Card title="Schedule a Demo" icon="calendar" href="https://calendly.com/qumis-dan/demo">
