...
<CardGroup cols={2}>
  ...
  <Card title="Custom Reports" icon="wand-sparkles" href="/reports/custom-reports">
...
<CardGroup cols={2}>
  ...
  <Card title="Create Custom Analysis" icon="wand-sparkles" href="/reports/custom-reports">
