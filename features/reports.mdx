...
<CardGroup cols={2}> <Card title="Contact Support" icon="life-ring" href="/resources/contact-support"> Get help from our team of insurance experts </Card> <Card title="Schedule a Demo" icon="calendar" href="https://calendly.com/qumis-dan/demo"> See Qumis Reports in action with a personalized walkthrough </Card> </CardGroup>