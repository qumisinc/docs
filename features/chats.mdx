...
<Frame caption="Qumis Home screen showing navigation and feature cards">
  ![Qumis Home screen showing navigation and feature cards](/images/screenshots/01.png)
</Frame>
...
<Frame caption="New Chat empty view with upload options">
  ![New Chat empty view with upload options](/images/screenshots/04.png)
</Frame>
...
<Frame caption="Processing OCR window showing document extraction progress">
  ![Processing OCR window showing document extraction progress](/images/screenshots/03.png)
</Frame>
...
<Frame caption="Chats interface showing loaded document and suggested actions">
  ![Chats interface showing loaded document and suggested actions](/images/screenshots/02.png)
</Frame>
