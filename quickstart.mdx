---
title: "Quickstart"
description: "Start using Qumis in minutes"
---
...
<Card title="Core Features" icon="sparkles" href="/features/chat-with-documents">
  Explore Qumis's powerful document analysis capabilities.
</Card>

<Card title="Policy Analysis" icon="file-search" href="/features/policy-analysis">
