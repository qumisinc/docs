...
<Tabs>
  <Tab title="Access & SSO">
    <ul>
    <li>
    New users: <a href="/get-started/setup-access/invite-users">
    Inviting Users</a>

    </li>

     <li>
    Roles: <a href="/get-started/setup-access/roles-permissions">
    Roles & Permissions</a>

    </li>

     <li>
    SSO setup & enforcement: <a href="/get-started/setup-access/sso">
  ...
  <Tab title="Reports">
    <ul>
    <li>
    Comparisons: <a href="/features/reports/comparisons">
    Comparisons</a>

    </li>

     <li>
    Coverage Table: <a href="/features/reports/coverage-table">
    Coverage Table</a>

    </li>

     <li>
    Client deliverables: <a href="/features/reports/custom-reports">
    Custom Reports</a>
  ...
  <Tab title="Playbooks">
    <ul>
    <li>
    Brokers: <a href="/workflows/broker/compare-quotes-binders">
    Compare Quotes & Binders</a>

    </li>

     <li>
    Claims: <a href="/workflows/claims/defensible-summaries">
    Defensible Claim Summaries</a>
