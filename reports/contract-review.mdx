...
<Frame caption="Contract Review dashboard showing different report types">
  <img src="/images/screenshots/contracts-dashboard.png" alt="Contract Review dashboard" />
</Frame>
...
<Frame caption="Uploading contract documents in Step 1">
  <img src="/images/screenshots/contracts-upload-documents.png" alt="Contract document upload interface" />
</Frame>
...
<Frame caption="Uploading insurance documents in Step 2">
  <img src="/images/screenshots/contracts-upload-insurance-docs.png" alt="Insurance documents upload interface" />
</Frame>
...
<Frame caption="Adding additional context in Step 3">
  <img src="/images/screenshots/contracts-additional-info.png" alt="Additional information input field" />
</Frame>
...
<Frame caption="Report generation in progress">
  <img src="/images/screenshots/contracts-generate-report.png" alt="Contract analysis generation progress screen" />
</Frame>
...
<Frame caption="Completed compliance comparison report">
  <img src="/images/screenshots/contracts-compliance-comparison.png" alt="Compliance comparison table showing requirements and policy details" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Identify compliance gaps" icon="magnifying-glass">
  ...
  <Card title="Communicate required changes" icon="comments">
  ...
  <Card title="Prioritize follow-up" icon="list-check">
  ...
  <Card title="Document your work" icon="file-lines">
...
<AccordionGroup>
  <Accordion title="I only uploaded a contract, and the system won't generate a report.">
  ...
  <Accordion title="The report shows 'Ambiguous' results.">
  ...
  <Accordion title="Where are my saved reports?">
