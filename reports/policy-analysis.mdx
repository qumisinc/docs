...
<Image src="/screenshots/15.png" alt="Single Policy Analysis dashboard in Qumis showing recent reports" width={1200} height={600} />
...
<Image src="/screenshots/16.png" alt="Uploading a policy document to Qumis Single Policy Analysis" width={1200} height={600} />
...
<Image src="/screenshots/17.png" alt="Adding additional information for Single Policy Analysis" width={1200} height={600} />
...
<Image src="/screenshots/18.png" alt="Generating Single Policy Analysis report progress view" width={1200} height={600} />
...
The goal is to quickly show where your firm can deliver better coverage, broader protection, or cost savings.

<Image src="/screenshots/19.png" alt="Completed Single Policy Analysis Report with Executive Summary and Chat" width={1200} height={600} />
...
<Image src="/screenshots/20.png" alt="Chatting with Qumis Clerk about Single Policy Analysis report" width={1200} height={600} />
...
- Reference specific weaknesses and gaps to show the prospect where their current coverage is inadequate.
...
- You can speak authoritatively about their coverage without lengthy manual review.
...
- **Add context for better analysis.** The more detail you provide in "Additional Information," the more targeted Qumis's analysis will be.
- **Review before pitching.** Always review the full report before meeting with the prospect so you understand the nuances of their coverage.
- **Use chat to prepare.** Ask Qumis clarifying questions about exclusions, limits, and terms before your pitch so you're fully prepared.
- **Highlight the wins.** Focus your pitch on opportunities where your firm can provide better coverage, more favorable terms, or cost savings.
- **Save your conversations.** Keep your chat threads with the report—they become part of your analysis file and help with consistency.
- **One policy per report.** Create separate analyses for each policy so reports stay organized and focused.

---

## Time savings example

**Traditional policy analysis (typical):**
...
- Total: 5-9 hours per policy

**With Qumis Single Policy Analysis:**

- Upload policy: 2 minutes
- Add context: 2 minutes
- Generate report: 5-10 minutes
- Review and ask clarifying questions: 5-10 minutes
- Total: 15-25 minutes per policy

You can now analyze multiple prospect policies in a single afternoon instead of days.
...
- Average generation time is 5–10 minutes. If it exceeds 15 minutes, refresh the page or re-upload your document.

**I don't see my uploaded document.**

- Ensure you've added it in the "Policy Documents" section before clicking "Generate Report."

**Can I analyze more than one policy at once?**

- The Single Policy tool is designed for one document at a time. For side-by-side comparisons, use the **Comparisons** feature instead.

**Where are my past analyses?**

- All completed reports appear on the **Single Policy Analysis dashboard**. Go to **Single Policy** in the left sidebar to access them.

**Can I edit the report after it's generated?**

- The report itself is generated by Qumis, but you can add notes and chat questions. Use the chat feature to clarify specific points or ask for deeper analysis.

**I want to compare two policies.**

- Create separate Single Policy Analysis reports for each policy, then use the **Comparisons** tool to review them side-by-side.
