...
<Tip>
Use real customer or internal examples — people relate to stories, not statistics.
</Tip>
...
<Steps>
<Step title="Upload both documents to your Vault">
Navigate to the Vault and upload the two policy documents you want to compare.
</Step>

<Step title="Select Compare Documents">
...
<Tip>
Document each win in your Value Tracker Pack (see below).
</Tip>
